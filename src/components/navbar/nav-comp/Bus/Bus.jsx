                                ...
                                <div className="filterBorderB">
                                    ...
                                    <hr></hr>
                                            ...
                                            <div className="busTypeB">
                                                ...
                                                <button
                                                    style={{
                                                        backgroundColor: selectedBusType.includes("AC") /*&& isToggled.busType*/ ? 'blue' : '#F3F6F8',
                                                        color: selectedBusType.includes("AC") /*&& isToggled.busType*/ ? 'white' : 'black'
                                                    }}
                                                    onClick={() => {
                                                        handleBusType("AC")
                                            ...
                                            <div className="departuresB">
                                                ...
                                                <button
                                                    style={{
                                                        backgroundColor: selectedDepartureTime.includes("12PMto6PM") /*&& isToggled.depart*/ ? 'blue' : '#F3F6F8',
                                                        color: selectedDepartureTime.includes("12PMto6PM") /*&& isToggled.depart*/ ? 'white' : 'black'
                                                    }}
                                                    onClick={() => {
                                            ...
                                            <div className="arrivalB">
                                                ...
                                                <button
                                                    style={{
                                                        backgroundColor: selectedArrivalTime.includes("before6AM") /*&& isToggled.arrive*/ ? 'blue' : '#F3F6F8',
                                                        color: selectedArrivalTime.includes("before6AM") /*&& isToggled.arrive*/ ? 'white' : 'black'
                                                    }}
                                                    onClick={() => {
